...
const Login = () => {
  ...
  return (
    <div className=" h-screen  flex flex-col justify-center items-center bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 px-4">
      ...
      <div className="w-full absolute top-5   text-center text-3xl mt-4 text-indigo-700 font-bold  mb-[100px] ">
      <Typewriter
        options={{
  ...
  'Your Money, Your Control 💼',],
      ...
      {!forgotPassword ? (
        ...
        <div className="w-3/4 md:w-2/4 h-auto mx-auto border bg-white border-gray-300   text-center rounded-xl shadow-2xl">
